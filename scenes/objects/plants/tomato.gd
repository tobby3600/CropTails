...
@export var tomato_frame_offset : int = 6
...
func _ready() -> void:
	...
	growth_cycle_component.crop_harversting.connect(on_crop_harvesting)

func _process(delta: float) -> void:
	growth_state = growth_cycle_component.get_current_growth_state()
	sprite_2d.frame = growth_state + tomato_frame_offset
